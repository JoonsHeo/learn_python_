...
numberIdx = -1
for i in range(3):
    if inputList[i] == "Fizz" or inputList[i] == "Buzz" or inputList[i] == "FizzBuzz":
        continue

    numberIdx = i
    break

numsToAdd = 3 - numberIdx

numToPrint = int(inputList[numberIdx]) + numsToAdd

if numToPrint%3 == 0 and numToPrint%5 == 0:
    print("FizzBuzz")
elif numToPrint%3 == 0:
    print("Fizz")
elif numToPrint%5 == 0:
